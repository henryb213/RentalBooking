...
export interface ToolListingFormProps {
  postcode: string;
  listing?: PopulatedListing;
}

const ToolListingForm: React.FC<ToolListingFormProps> = ({
  listing,
  postcode,
}) => {
    ...
    <div className="space-y-12">
      ...
      <div>
        ...
        <ListingCreator.TextField
          field="name"
          className="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-primary placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm/6"
        />
      </div>
